...
-- Create the table
CREATE TABLE challenge_6.sustainable_clothing (
...
INSERT INTO challenge_6.sustainable_clothing (product_id, product_name, category, size, price)
VALUES
...
-- Create the table
CREATE TABLE challenge_6.marketing_campaigns (
campaign_id INT PRIMARY KEY,
campaign_name VARCHAR(100),
product_id INT,
start_date DATE,
end_date DATE,
FOREIGN KEY (product_id) REFERENCES challenge_6.sustainable_clothing (product_id)
);
-- Insert data into the table
INSERT INTO challenge_6.marketing_campaigns (campaign_id, campaign_name, product_id, start_date, end_date)
VALUES
...
-- Create the table
CREATE TABLE challenge_6.transactions (
...
-- Insert data into the table
INSERT INTO challenge_6.transactions (transaction_id, product_id, quantity, purchase_date)
VALUES
(1, 2, 2, '2023-06-02'),
(2, 14, 1, '2023-06-02'),
(3, 5, 2, '2023-06-05'),
