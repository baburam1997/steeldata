...
CREATE TABLE challenge_5.beverages (
...
CREATE TABLE challenge_5.sales (
sale_id INT PRIMARY KEY,
pub_id INT,
beverage_id INT,
quantity INT,
transaction_date DATE,
FOREIGN KEY (pub_id) REFERENCES challenge_5.pubs(pub_id),
FOREIGN KEY (beverage_id) REFERENCES challenge_5.beverages(beverage_id)
);
--------------------
---Create the 'ratings' table 
CREATE TABLE challenge_5.ratings ( 
...
INSERT INTO challenge_5.pubs (pub_id, pub_name, city, state, country)
VALUES
...
INSERT INTO challenge_5.beverages (beverage_id, beverage_name, category, alcohol_content, price_per_unit)
VALUES
...
--------------------
INSERT INTO challenge_5.sales (sale_id, pub_id, beverage_id, quantity, transaction_date)
VALUES
(1, 1, 1, 10, '2023-05-01'),
(2, 1, 2, 5, '2023-05-01'),
(3, 2, 1, 8, '2023-05-01'),
...
INSERT INTO challenge_5.ratings (rating_id, pub_id, customer_name, rating, review)
VALUES
