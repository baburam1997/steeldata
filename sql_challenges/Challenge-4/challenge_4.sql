...
CREATE TABLE challenge_4.Customers (
...
INSERT INTO challenge_4.Customers (CustomerID, FirstName, LastName, City, State)
...
CREATE TABLE challenge_4.Branches (
...
INSERT INTO challenge_4.Branches (BranchID, BranchName, City, State)
...
CREATE TABLE challenge_4.Accounts (
AccountID INT PRIMARY KEY,
CustomerID INT NOT NULL,
BranchID INT NOT NULL,
AccountType VARCHAR(50) NOT NULL,
Balance DECIMAL(10, 2) NOT NULL,
FOREIGN KEY (CustomerID) REFERENCES challenge_4.Customers(CustomerID),
FOREIGN KEY (BranchID) REFERENCES challenge_4.Branches(BranchID)
);
--------------------
-- Populate the Accounts table
INSERT INTO challenge_4.Accounts (AccountID, CustomerID, BranchID, AccountType, Balance)
...
CREATE TABLE challenge_4.Transactions (
TransactionID INT PRIMARY KEY,
AccountID INT NOT NULL,
TransactionDate DATE NOT NULL,
Amount DECIMAL(10, 2) NOT NULL,
FOREIGN KEY (AccountID) REFERENCES challenge_4.Accounts(AccountID)
);
--------------------
-- Populate the Transactions table
INSERT INTO challenge_4.Transactions (TransactionID, AccountID, TransactionDate, Amount)
